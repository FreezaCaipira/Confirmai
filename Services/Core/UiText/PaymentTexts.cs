...
internal static class PaymentTexts
{
    ...
    public static IReadOnlyDictionary<string, string> PtBr => new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Payment.ProofInvalidImage"] = "Envie uma imagem válida (JPG, PNG ou WebP).",
        ["Payment.ProofForbidden"] = "Você só pode enviar comprovante do seu próprio pagamento.",
        ...
        ["Payment.Settlement.RejectReasonRequired"] = "Informe o motivo da rejeição.",
    ...
    public static IReadOnlyDictionary<string, string> EnUs => new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Payment.ProofInvalidImage"] = "Please upload a valid image (JPG, PNG or WebP).",
        ["Payment.ProofForbidden"] = "You can only upload a proof for your own payment.",
        ...
        ["Payment.Settlement.RejectReasonRequired"] = "Please provide a reason for the rejection.",
    ...
    public static IReadOnlyDictionary<string, string> EsEs => new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Payment.ProofInvalidImage"] = "Envie una imagen valida (JPG, PNG o WebP).",
        ["Payment.ProofForbidden"] = "Solo puedes enviar el comprobante de tu propio pago.",
        ...
        ["Payment.Settlement.RejectReasonRequired"] = "Informe el motivo del rechazo.",
