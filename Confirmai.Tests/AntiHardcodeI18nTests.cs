...
public class AntiHardcodeI18nTests
{
    ...
    private static readonly HashSet<string> ResidualAllowlist = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        // ── Unaccented PT words detected by Fase A (C28). These are the same
        // residuals as above but without accented chars — the new detection
        // catches them. They will be migrated in Fase B.
        "AdminUserView|Contato",
        "AdminUserView|Permite criar e editar quadras/venues no portal do gestor.",
        "EscalacaoConfirmed|Reserva",
        "EscalacaoVoting|Destaque da Partida",
        "DetailEventHeader|Voltar",
        "EscalacaoDraftTeamBuilder|Reserva",
        "RecurrenceScheduler|Dias da semana",
        "Index|Confirmar",
        "PayoutAccountEditor|Telefone",
        "ProductForm|Categoria",
        "CitySelector|Filtro de cidade",
        "EventListingShell|Selecionar data",
        "EventListingShell|Dia anterior",
        "EventListingShell|Carregando",
        "EventListingShell|Ver hoje",
        "FutsalWaitlist|Lista de espera",
        "GroupDetailEvents|Data/Hora",
        "GroupDetailEvents|Status",
        "GroupDetailEvents|Nenhuma partida agendada.",
        "GroupDetailEvents|Nenhuma partida realizada.",
        "GroupDetailMembers|Sem membros.",
        "GroupDetailMembers|admin",
        "GroupDetailPaymentsModal|Recarregar lista",
        "GroupDetailPaymentsModal|Recarregar",
        "GroupDetailPaymentsModal|Todos os participantes",
        "GroupDetailPaymentsModal|Nenhum pagamento manual registrado ainda.",
        "GroupDetailPaymentsModal|Nenhum jogador inadimplente. Tudo em dia!",
        "GroupDetailPaymentsModal|Jogador enviou comprovante",
        "GroupDetailPaymentsModal|Partidas pendentes",
        "GroupDetailPendingRequests|Nome A-Z",
        "GroupDetailPendingRequests|selecionado",
        "GroupMetrics|Membros",
        "RankingTable|Nome",
        "MainLayout|Grupos",
        "MainLayout|Admin",
        "UserSummaryCard|Email:",
        "UserSummaryCard|Nome completo:",
        "UserSummaryCard|Data de nascimento:",
        "UserSummaryCard|Status:",
        "UserSummaryCard|Ativo",
    };
